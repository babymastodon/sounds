...
- [`conv8`](conv8/README.md) turns `conv7` into a controlled additive-pitch playground. Deterministic hashes select one of 13 naturally detuned 13-EDO chords and one of three gritty synthesized instruments for every short/long pair, then two matched matrices compare notes added to the long input versus the short input before convolution.
