...
- [`conv8`](conv8/README.md) turns `conv7` into a controlled pitch-and-rhythm playground. A deterministic content hash selects one of 13 Bohlen–Pierce chords for every short/long pair, then four matched matrices compare subtle convolutional resonance, rhythmic sequenced convolution, hybrid spectral modulation, and locally leveled additive notes in the long input.
