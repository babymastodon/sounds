...
The desktop app uses native window decorations, disables minimize/maximize, loops audio automatically, preserves playback position across renders, provides independent volume and 0.5×–2× listening-speed controls, and displays waveform plus a 16,384-point, up-to-2,880-column log-frequency spectrogram. See [`app/README.md`](app/README.md) for prerequisites and tests.
