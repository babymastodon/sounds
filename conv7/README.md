...
The regenerated final master contains 696,287,424 frames (4:01:45.988), with all 575 transitions receiving the complete ten-second crossfade and none shortened. RF64 assembly, four parallel encoders, and end-to-end decode checks took 3:12.25 with peak resident memory of 701,552 KiB. Outputs are a 2,785,149,776-byte stereo RF64, 902,719,299-byte FLAC, 350,869,653-byte AAC/M4A, 221,972,444-byte 128 kbit/s Opus, and 56,032,148-byte 32 kbit/s Opus. Every compressed master decoded without errors.
