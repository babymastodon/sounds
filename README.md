...
- [`conv8`](conv8/README.md) turns `conv7` into a controlled additive-pitch playground. A deterministic content hash selects one of 13 Bohlen–Pierce chords for every short/long pair, then two matched matrices compare locally leveled synthesized notes added to the long input versus the short input before convolution.
