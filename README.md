...
- [`conv9`](conv9/README.md) breaks the whole-clip model to avoid long-convolution smear. Twelve diverse one-minute sources advance in normalized lockstep through unequal A/B windows; all 66 pairs compare multiresolution, sliding WOLA, dual evolving-IR, and crossfaded-chunk convolution at three window scales. Its 792-file hierarchy is paired with a Tauri waveform/spectrogram comparison app.
