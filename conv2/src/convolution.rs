...
pub fn convolve_stereo_spectra(
    ...
    let shortened_track_1 = trim_final(&clips[job.left].samples, job.trim_frames);
...
mod tests {
    ...
    fn asymmetric_fft_convolution_matches_direct_convolution() {
        ...
        let expected_right =
            direct_convolution(&trim_final(&clips[0].samples, 2), &clips[1].samples);
    ...
    #[test]
    fn final_trim_uses_a_faded_cut() {
